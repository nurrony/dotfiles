...
() {
  ...
  # Package
  typeset -g POWERLEVEL9K_MISE_PACKAGE_BACKGROUND=2
  # Java
  typeset -g POWERLEVEL9K_MISE_JAVA_BACKGROUND=75
  typeset -g POWERLEVEL9K_MISE_JAVA_FOREGROUND=#212121
  typeset -g POWERLEVEL9K_MISE_JAVA_SHOW_ON_UPGLOB="*.java|*.jar|*.class|pom.xml|mvnw|mvnw.cmd|*.gradle"
